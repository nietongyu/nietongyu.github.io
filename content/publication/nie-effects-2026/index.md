---
title: Effects of Field-of-View Restriction and Peripheral Teleportation on Path
...
publication_types:
- article-journal
publication: '*IEEE Transactions on Visualization and Computer Graphics (Proc. IEEE ISMAR 2026)*'
tags:
- journal
---
## Abstract
...
The Unity builds of the experiment can be found on [OSF](https://osf.io/jgx6p).
